 ...
 */
@Service("ipPoolProxy")
public class DownLoadPageByIpPoolServiceImpl implements IDownLoadPage{
        ...
        if (StringUtils.isNotBlank(url)) {
            ...
            try {
                ...
                if(iPoolProxy==null){
                    ...
                    //设置头部信息
                    result = HttpClientUtils.get(url, charset,connTimeout,readTimeout, headers,iPoolProxy);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        if (StringUtils.isNotBlank(url)) {
            ...
            try {
                ...
                if(iPoolProxy==null){
                    ...
                    //设置头部信息
                    result = HttpClientUtils.post(url, params, charset, headers, iPoolProxy);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        if (StringUtils.isNotBlank(url)) {
            ...
            try {
                ...
                if(iPoolProxy==null){
                    ...
                    //设置头部信息
                    result = HttpClientUtils.post(url, json, charset, headers, iPoolProxy);
                }
