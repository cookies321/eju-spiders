...
public class AnjukeCommunityWithBLOBs extends AnjukeCommunity implements Serializable {
    ...
    public String toString() {
        return "AnjukeCommunityWithBLOBs{" +
                "overheadInformation='" + overheadInformation + '\'' +
                ", communication='" + communication + '\'' +
                ", exitInfos='" + exitInfos + '\'' +
                ", traffic='" + traffic + '\'' +
                ", peripheralInformation='" + peripheralInformation + '\'' +
                ", xiaoquAveragepriceUrl='" + xiaoquAveragepriceUrl + '\'' +
                ", openInformationHistory='" + openInformationHistory + '\'' +
                ", photoJson='" + photoJson + '\'' +
                ", layoutImages='" + layoutImages + '\'' +
                ", realityImages='" + realityImages + '\'' +
                "} " + super.toString();
    }
}