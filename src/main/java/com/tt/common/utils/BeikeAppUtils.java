...
//        System.out.println(post);
    ...
    public static String createAuthorizationStr(String str, String str2, String str3, Map<String, String> map) {
        Object obj;
        String accessKeyId = "netstat";//LJTrafficStats.getGatewayConfigApiImpl().getAccessKeyId();
        String accessKeySecret = "P1dqpt9nbHfJ12NV";//LJTrafficStats.getGatewayConfigApiImpl().getAccessKeySecret();
        ...
        stringBuilder4.append("accessKeyId=");
        stringBuilder4.append(accessKeyId);
        ...
        stringBuilder5.append("LJ-HMAC-SHA256 ");
        stringBuilder5.append("accessKeyId=");
        stringBuilder5.append(accessKeyId);
        stringBuilder5.append("; ");
        stringBuilder5.append("nonce=");
        stringBuilder5.append(md5);
        stringBuilder5.append("; ");
        stringBuilder5.append("timestamp=");
        stringBuilder5.append(stringBuilder3);
        stringBuilder5.append("; ");
        stringBuilder5.append("signature=");
        stringBuilder5.append(sign(str, accessKeySecret));
        stringBuilder5.append("; ");
