...
import com.tt.dao.AnjukeJjrEsfgoodsPicMapper;
...
public class ParseAngentDetail {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //列表
        AnjukeBrokerListMapper anjukeBrokerListMapper = (AnjukeBrokerListMapper)applicationContext.getBean("anjukeBrokerListMapper");
        //详情
        AnjukeBrokerEsfgoodsDetailMapper anjukeBrokerEsfgoodsDetailMapper = (AnjukeBrokerEsfgoodsDetailMapper)applicationContext.getBean("anjukeBrokerEsfgoodsDetailMapper");
        //图片
        AnjukeJjrEsfgoodsPicMapper anjukeJjrEsfgoodsPicMapper = (AnjukeJjrEsfgoodsPicMapper)applicationContext.getBean("anjukeJjrEsfgoodsPicMapper");
        ...
        for (AnjukeBrokerList anjukeBrokerList : anjukeBrokerLists) {
            ...
            if(anjukeBrokerEsfgoodsDetails.size()!=0){
                //解析二手房的主页链接
                    ...
                    executor.execute(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                System.out.println("==================="+anjukeBrokerEsfgoodsDetail);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }finally {
                                semaphore.release();
     ...
     */
    private static void parseGoodsDetail(Document documentGoodsDetail, AnjukeBrokerEsfgoodsDetailWithBLOBs anjukeBrokerEsfgoodsDetail) {
     ...
     */
    private static List<AnjukeBrokerEsfgoodsDetailWithBLOBs> parseDetail(Document documentDetail,List<AnjukeBrokerEsfgoodsDetailWithBLOBs> list) {
        if(documentDetail!=null){
            ...
            if(!selectPage.isEmpty()){
                ...
                if(StringUtils.isNotBlank(hrefNext)){
                    ...
                    documentDetail = DownLoadPage.downLoadPage(hrefNext);
